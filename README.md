...
First go the app and search the area: you will see the app module, Activate it 
...
here you can do create invoice , confirm invoice but can't do deletion if the user is defined for the Area-Based Access group.
And Bill also.
